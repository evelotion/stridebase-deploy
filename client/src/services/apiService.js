...
export const getStores = (params) => apiRequest(`/api/stores?${params.toString()}`);
export const getStoreDetails = (storeId) => apiRequest(`/api/stores/${storeId}`);
export const getStoreServices = (storeId) => apiRequest(`/api/stores/${storeId}/services`);
export const getStoreReviews = (storeId) => apiRequest(`/api/stores/${storeId}/reviews`);
...
export const addUserAddress = (addressData) => apiRequest('/api/user/addresses', 'POST', addressData);
export const deleteUserAddress = (addressId) => apiRequest(`/api/user/addresses/${addressId}`, 'DELETE');
export const updateUserProfile = (profileData) => apiRequest('/api/user/profile', 'PUT', profileData);
...
export const redeemLoyaltyPoints = (pointsToRedeem) => apiRequest('/api/user/loyalty/redeem', 'POST', { pointsToRedeem });

// --- Booking & Review Endpoints ---
export const createBooking = (bookingData) => apiRequest('/api/bookings', 'POST', bookingData);
export const getBookingDetails = (bookingId) => apiRequest(`/api/bookings/${bookingId}`);
export const createReview = (reviewData) => apiRequest('/api/reviews', 'POST', reviewData);

// --- Upload Endpoint ---
export const uploadImage = (formData) => apiRequest('/api/upload/review', 'POST', formData, true);

// --- Partner Endpoints ---
export const getPartnerDashboard = () => apiRequest('/api/partner/dashboard');
export const getOutstandingInvoices = () => apiRequest('/api/partner/invoices/outstanding');
export const getPartnerSettings = () => apiRequest('/api/partner/settings');
export const updatePartnerSettings = (settingsData) => apiRequest('/api/partner/settings', 'PUT', settingsData);
export const uploadPartnerPhoto = (formData) => apiRequest('/api/partner/upload-photo', 'POST', formData, true);
export const getPartnerServices = () => apiRequest('/api/partner/services');
export const createPartnerService = (serviceData) => apiRequest('/api/partner/services', 'POST', serviceData);
export const updatePartnerService = (serviceId, serviceData) => apiRequest(`/api/partner/services/${serviceId}`, 'PUT', serviceData);
export const deletePartnerService = (serviceId) => apiRequest(`/api/partner/services/${serviceId}`, 'DELETE');
export const getPartnerOrders = () => apiRequest('/api/partner/orders');
export const updateWorkStatus = (bookingId, newWorkStatus) => apiRequest(`/api/partner/orders/${bookingId}/work-status`, 'PATCH', { newWorkStatus });
...
export const changeUserStatus = (userId, newStatus) => apiRequest(`/api/admin/users/${userId}/status`, 'PATCH', { newStatus });
export const getAllStoresForAdmin = () => apiRequest('/api/admin/stores');
export const updateStoreStatus = (storeId, newStatus) => apiRequest(`/api/admin/stores/${storeId}/status`, 'PATCH', { newStatus });
export const getPayoutRequests = () => apiRequest('/api/admin/payout-requests');
export const resolvePayoutRequest = (requestId, newStatus) => apiRequest(`/api/admin/payout-requests/${requestId}/resolve`, 'PATCH', { newStatus });
